...
watch(allSelected1, (val) => {
  table1Rows.value.forEach(row => { row.selected = val })
})
watch(allSelected2, (val) => {
  table2Rows.value.forEach(row => { row.selected = val })
})
watch(allSelected3, (val) => {
  table3Rows.value.forEach(row => { row.selected = val })
})
watch(allSelected4, (val) => {
  table4Rows.value.forEach(row => { row.selected = val })
})

    ...
    <q-list class="full-width">
      <q-expansion-item default-opened icon="inventory" label="厂站安全检查">
        <q-item
          ...
          clickable
          :inset-level="1"
          @click="router.push('/security_basic')"
        >
        ...
        <q-item
          ...
          clickable
          :inset-level="1"
          @click="router.push('/device_check')"
        >
...
<q-list class="full-width">
      <q-item v-ripple clickable @click="router.push('/example_test')">
        <q-item-section avatar>
          <Icon name="majesticons:file-report" size="24" mode="svg" />
        </q-item-section>
        <q-item-section>grpc调用方法</q-item-section>
      </q-item>
    </q-list>
    <q-list class="full-width">
    ...
    <q-list class="full-width">
      <q-item v-ripple clickable @click="router.push('/rectification_notice')">
        <q-item-section avatar>
          <Icon
            name="material-symbols-light:chat-info-rounded"
            size="24"
            mode="svg"
          />
        </q-item-section>
    ...
    <q-list class="full-width">
      <q-item v-ripple clickable @click="router.push('/user_manage')">
        <q-item-section avatar>
    ...
    <q-list class="full-width">
      <q-item v-ripple clickable @click="router.push('/sys_manage')">
        <q-item-section avatar>
